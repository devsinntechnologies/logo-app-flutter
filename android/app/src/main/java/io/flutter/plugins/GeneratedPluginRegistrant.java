...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new google.ads.helper.google_ads_helper.GoogleAdsHelperPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin google_ads_helper, google.ads.helper.google_ads_helper.GoogleAdsHelperPlugin", e);
    }
    try {
